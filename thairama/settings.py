"""
Django settings for thairama project.
...
SECRET_KEY = 'ryex%f0cs7y+551^+l7qsd&ushupim7(b6wged@cd5(v8)%mqh'
...
ROOT_URLCONF = 'thairama.urls'

WSGI_APPLICATION = 'thairama.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, '../thairamaapp/static'),
)
