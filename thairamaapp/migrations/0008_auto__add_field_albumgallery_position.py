...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumGallery.position'
        db.add_column(u'thairamaapp_albumgallery', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumGallery.position'
        db.delete_column(u'thairamaapp_albumgallery', 'position')


    models = {
        u'thairamaapp.albumgallery': {
            'Meta': {'ordering': "['position']", 'object_name': 'AlbumGallery'},
