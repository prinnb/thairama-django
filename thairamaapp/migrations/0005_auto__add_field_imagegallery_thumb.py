...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageGallery.thumb'
        db.add_column(u'thairamaapp_imagegallery', 'thumb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageGallery.thumb'
        db.delete_column(u'thairamaapp_imagegallery', 'thumb')
