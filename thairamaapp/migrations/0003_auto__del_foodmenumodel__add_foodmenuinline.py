...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FoodMenuInline'
        db.create_table(u'thairamaapp_foodmenuinline', (
        ...
        db.send_create_signal(u'thairamaapp', ['FoodMenuInline'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FoodMenuInline'
        db.delete_table(u'thairamaapp_foodmenuinline')
    ...
    models = {
        ...
        u'thairamaapp.foodmenuinline': {
            'Meta': {'ordering': "['position']", 'object_name': 'FoodMenuInline'},
